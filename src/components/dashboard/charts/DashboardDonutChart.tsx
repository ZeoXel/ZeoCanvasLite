...
import { VChartWrapper, CHART_CONFIG } from './VChartWrapper';
...
export const DashboardDonutChart: React.FC<VDonutChartProps> = ({
    data,
}) => {
    ...
    return (
        <div className="w-full h-full">
            <VChartWrapper spec={spec} options={CHART_CONFIG} />
        </div>
    );
};
